...
function getServiceFaqs(service) {
  return [
    [
      `O que e ${service.navLabel} na CORPAD Consultoria?`,
      `${service.navLabel} e uma solucao consultiva para empresas que precisam organizar gestao, tecnologia, processos e decisoes com apoio pratico.`,
    ],
    [
      `${service.navLabel} atende empresas de quais regioes?`,
      "A CORPAD atende empresas em Monte Alto, regiao de Ribeirao Preto, Sao Paulo e todo o Brasil por canais digitais e consultivos.",
    ],
    [
      `Como funciona o processo de ${service.navLabel}?`,
      `O processo envolve ${service.process.join(", ").toLowerCase()} e acompanhamento para evoluir a operacao da empresa.`,
    ],
    [
      "Essa pagina esta preparada para SEO, GEO e AEO?",
      "Sim. A pagina tem HTML pre-renderizado, descricao do servico, contexto local, processo, respostas diretas e dados estruturados Schema.org.",
    ],
  ];
}
